...
public class experimentParser extends Parser {
	...
	public static class ChatContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof experimentListener ) ((experimentListener)listener).enterChat(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof experimentListener ) ((experimentListener)listener).exitChat(this);
		}
	}
	...
	public static class LineContext extends ParserRuleContext {
		...
		public TerminalNode THE() { return getToken(experimentParser.THE, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof experimentListener ) ((experimentListener)listener).enterLine(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof experimentListener ) ((experimentListener)listener).exitLine(this);
		}
	}
	...
	public static class NameContext extends ParserRuleContext {
		public TerminalNode WORD() { return getToken(experimentParser.WORD, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof experimentListener ) ((experimentListener)listener).enterName(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof experimentListener ) ((experimentListener)listener).exitName(this);
		}
	}
	...
	public static class OpinionContext extends ParserRuleContext {
		public TerminalNode TEXT() { return getToken(experimentParser.TEXT, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof experimentListener ) ((experimentListener)listener).enterOpinion(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof experimentListener ) ((experimentListener)listener).exitOpinion(this);
		}
	}
